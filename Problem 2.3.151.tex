\thm{2.3.16a}{Let $A$ be an algebra over a field $k$. The center $Z(A)$ of $A$ is the set of all elements $z \in A$ which commute with all elements of $A$. For example, if $A$ is commutative, then $Z(A)=A$.

Show that if $V$ is an irreducible finite dimensional representation of $A$, then any element $z \in Z(A)$ acts in $V$ by multiplication by some scalar $\chi_V : Z(A) \to k$ is a homomorphism. It is called the central character of $V$.}
